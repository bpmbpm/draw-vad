...
- задать иной идентификатор схемы \ заголовка в схеме процесса. Например, процессы - p, а схема процесса sp. И далее по аналоии к любому типу объектов добавлять "s". 
